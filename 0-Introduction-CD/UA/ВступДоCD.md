...
Уявіть: ваша команда щойно виправила критичний баг. Патч готовий, протестований і схвалений. Але він не потрапить до користувачів ще два тижні — бо саме тоді відкриється наступне вікно релізу. Тим часом клієнти розчаровані, тікети в підтримку накопичуються, а конкуренти випускають оновлення швидше. Знайомо?

Саме цю проблему покликана вирішити Continuous Delivery.
...
Continuous Delivery (CD) або Безперервна Доставка представляє фундаментальну зміну в тому, як сучасні організації, що займаються розробкою програмного забезпечення, доставляють цінність своїм користувачам. Як сформулював Джез Хамбл на [continuousdelivery.com](https://continuousdelivery.com):
...
Подібно до DevOps, Continuous Delivery — це не просто набір інструментів чи практик, це **технологічна** та **культурна** трансформація для організації. Вона вимагає фундаментальної зміни мислення, процесів та моделей співпраці команд для досягнення справді стійких практик доставки програмного забезпечення.
