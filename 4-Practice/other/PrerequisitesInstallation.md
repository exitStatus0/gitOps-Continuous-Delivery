# Руководство по установке предварительных требований

Этот гайд поможет вам подготовить рабочее окружение для практической работы по ArgoCD. В конце у вас должно быть всё необходимое для **macOS**, **Linux** или **Windows**, чтобы лабораторная воспринималась как практика, а не как борьба с настройкой.
...
Перед началом лабораторной убедитесь, что следующие инструменты установлены и работают:
...
- [Русская версия (Russian)](PracticeLab.md)
