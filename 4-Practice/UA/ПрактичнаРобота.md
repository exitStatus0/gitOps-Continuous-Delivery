...
У цій лабораторній ви приміряєте роль розробника в **Forge World Sigma-VII**. Ваше завдання — взяти новий сервіс **cogitator** і розгорнути його в Kubernetes, використовуючи ArgoCD та практики GitOps.
...
Цікавість цієї вправи не лише в самому розгортанні. Платформна команда Forge World Sigma-VII побудувала нове Kubernetes-середовище, і саме команда cogitator отримує шанс однією з перших попрацювати в ньому.

А це означає і зміну самої моделі релізів. Замість тікетів, очікування вікна релізу та окремих релізних зустрічей організація переходить на **GitOps-підхід з ArgoCD**.

**До ArgoCD** процес виглядав так:
...
**З ArgoCD** робочий процес стає таким:
...
> **Потрібна допомога зі встановленням цих інструментів?** Дивіться детальний [Посібник зі встановлення передумов](ПередумовиВстановлення.md) з покроковими інструкціями для macOS, Linux та Windows.
...
Сприймайте ці питання як коротку самоперевірку:
