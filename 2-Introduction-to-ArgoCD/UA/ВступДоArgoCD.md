...
- Кластер Kubernetes (v1.21 або новіший)
...
- Попрактикуйтеся в розгортанні зразкового додатку з ArgoCD
- Досліджуйте розширені функції, такі як Argo Rollouts для прогресивної доставки
- Приєднайтеся до спільноти ArgoCD в Slack та на GitHub

Щасливого GitOps-інгу! 🚀
