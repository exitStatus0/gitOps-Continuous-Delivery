...
*Представьте: 2 часа ночи, ваш production-кластер лежит, а человек, который последний раз его настраивал, уволился несколько месяцев назад. Никто не знает, что изменилось, никто не может воспроизвести настройку, и каждая минута простоя стоит денег. А что, если бы всю вашу инфраструктуру можно было восстановить из одного Git-репозитория за считанные минуты — с полным аудитом каждого изменения?*
