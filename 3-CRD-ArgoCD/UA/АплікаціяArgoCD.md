...
**Application CRD (Custom Resource Definition)** є найважливішим ресурсом, представленим ArgoCD. Він декларативно визначає процес розгортання маніфестів у Kubernetes, включаючи:
- Звідки брати маніфести
- Як їх рендерити
- Коли розгортати ресурси
- Коли узгоджувати живий стан з бажаним станом
- І набагато більше

Цей документ надає повне керівництво для розуміння та роботи з CRD Аплікацій ArgoCD.
